...
//         setError('No tasks found that you assigned to others.');
//       }
...
//       if (user._id !== selectedIssue.createdBy._id.toString() && user.email !== 'Admin@gmail.com') {
...
//       setFormData({ userName: '', description: '', status: 'pending', priority: 'Medium' });
//       if (Date.now() - start < 2000) await new Promise(resolve => setTimeout(resolve, 2000 - (Date.now() - start)));
//     } catch (err) {
//       setError(err.message);
//     } finally {
...
//       if (user._id !== issue.createdBy._id.toString() && user.email !== 'Admin@gmail.com') {
...
//           <h1 className="text-2xl font-bold">Tasks Assigned to Others</h1>
//         </div>
...
//                     <td className="p-3">{truncateDescription(issue.description)}</td>
//                     <td className="p-3">{issue.branch?.branchName || 'N/A'}</td>
//                     <td className="p-3">{issue.department?.departmentName || 'N/A'}</td>
//                     <td className="p-3">{statusDisplay[issue.status] || issue.status}</td>
//                     <td className="p-3">{issue.priority}</td>
//                     <td className="p-3">{issue.assignedTo?.name || 'N/A'}</td>
...
//             ) : (
//               <div>
//                 <p><strong>Title:</strong> {selectedIssue.userName}</p>
//                 <p><strong>Description:</strong> {selectedIssue.description || 'N/A'}</p>
//                 <p><strong>Branch:</strong> {selectedIssue.branch?.branchName || 'N/A'}</p>
//                 <p><strong>Department:</strong> {selectedIssue.department?.departmentName || 'N/A'}</p>
//                 <p><strong>Status:</strong> {statusDisplay[selectedIssue.status] || selectedIssue.status}</p>
//                 <p><strong>Priority:</strong> {selectedIssue.priority}</p>
//                 <p><strong>Assigned To:</strong> {selectedIssue.assignedTo?.name || 'N/A'}</p>
//                 <p><strong>Created By:</strong> {selectedIssue.createdBy?.name || 'N/A'}</p>
//                 <p><strong>Created At:</strong> {new Date(selectedIssue.createdAt).toLocaleDateString()}</p>
