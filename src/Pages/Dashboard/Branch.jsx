...
const Branch = () => {
  ...
  const fetchBranches = async () => {
    ...
    try {
      ...
      const response = await fetch('https://bugbuster-backend.vercel.app/api/branches', {
        headers: {
  ...
  const handleUpdateBranch = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`https://bugbuster-backend.vercel.app/api/branches/${selectedBranch._id}`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json',
  ...
  const handleDeleteBranch = async (branch) => {
    ...
    try {
      ...
      const response = await fetch(`https://bugbuster-backend.vercel.app/api/branches/${branch._id}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json',
