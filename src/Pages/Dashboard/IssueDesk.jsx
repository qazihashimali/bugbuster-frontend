...
export default function IssueDesk() {
  ...
  const handleDescriptionSelect = (value) => {
    if (value === "custom") {
      ...
      setSelectedDescriptions(["custom"]);
      setFormData((prev) => ({ ...prev, description: "" }));
    } else if (value) {
      setSelectedDescriptions((prev) => {
        // Uncheck "custom" if another is selected
        const newSet = new Set(prev.filter((desc) => desc !== "custom"));
                  ...
                  <div className="relative">
                    ...
                    {isDescriptionOpen && (
                      <ul className="absolute w-full bg-white border border-gray-200 rounded-md mt-1 z-50 max-h-40 overflow-y-auto shadow-lg backdrop-blur-0 bg-opacity-100">
                        ...
                        <li
                          ...
                          onClick={() =>
                            handleDescriptionSelect(
                              "Issue with SoftStartUP™ - Details: The device is not starting properly."
                            )
                          }
                        >
                          <div className="flex items-center">
                            ...
                            />
                            <span>Issue with SoftStartUP™</span>
                          </div>
                          <button
                            type="button"
                            ...
                            onClick={(e) => {
                              ...
                              setIsDetailsOpen((prev) => ({
                                ...prev,
                                "Issue with SoftStartUP™":
                                  !prev["Issue with SoftStartUP™"],
                              }));
                            }}
                          >
                            <IoChevronDown
                        ...
                        {isDetailsOpen["Issue with SoftStartUP™"] && (
                        ...
                        <li
                          ...
                          onClick={() =>
                            handleDescriptionSelect(
                              "Weatherproof Concern - Details: Needs cover from heavy rain."
                            )
                          }
                        >
                          <div className="flex items-center">
                            <input
                              ...
                              className="mr-2 h-4 w-4 text-orange-600 border-gray-300 rounded focus:ring-orange-500"
                            />
                            <span>Weatherproof Concern</span>
                          </div>
                          <button
                            type="button"
                            className="text-orange-600 hover:text-orange-800 ml-2 flex items-center"
                            onClick={(e) => {
                              ...
                              setIsDetailsOpen((prev) => ({
                                ...prev,
                                "Weatherproof Concern":
                                  !prev["Weatherproof Concern"],
                              }));
                            }}
                          >
                            <IoChevronDown
                        ...
                        {isDetailsOpen["Weatherproof Concern"] && (
                          <li className="px-6 py-2 text-white bg-primary rounded-b-md">
                        ...
                        >
                          <div className="flex items-center w-full">
                            <input
                              type="checkbox"
                              checked={selectedDescriptions.includes("custom")}
                              onChange={() => {}}
                              className="mr-2 h-4 w-4 text-orange-600 border-gray-300 rounded focus:ring-orange-500"
                            />
                    ...
                    {selectedDescriptions.includes("custom") && (
