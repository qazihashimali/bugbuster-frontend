  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isLogin) {
        ...
        if (roles.EndUser === true && (!phone || !houseNumber || !block)) {
          throw new Error(
            "Phone, house number, and block are required for EndUser"
          );
        }
        ...
        const body = {
          ...
          houseNo: roles.EndUser ? houseNumber : undefined,
      ...
      >
        <div
          style={{
            ...
            scrollbarWidth: !isLogin ? "none" : "auto", // Firefox
            msOverflowStyle: !isLogin ? "none" : "auto", // IE/Edge
          }}
        >
          <style>
            {`
